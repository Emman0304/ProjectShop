...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Project Shopping</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="{{ route('Admindashboard') }}" class="nav-link {{ isset($activeDash) ? $activeDash:'open'}}">
          ...
          <li class="nav-item">
            <a href="{{ route('branchlist') }}" class="nav-link {{ isset($activeBranch) ? $activeBranch:''}}">
              {{-- <i class="nav-icon fas fa-th"></i> --}}
              <p>
                Branch File
              </p>
          ...
          <li class="nav-item {{ isset($EmployeeMenu) ? $EmployeeMenu:'' }} ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('employeeList') }}" class="nav-link {{ isset($listActive) ? $listActive:'' }}">
